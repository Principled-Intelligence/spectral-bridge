"""Responses pass-through adapter.

Forwards OpenAI Responses API requests to a local endpoint.
Use when the target already exposes /v1/responses.
"""
...
app = FastAPI(title="spectral-bridge responses pass-through adapter", lifespan=lifespan)
